  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
     <input type="hidden" wire:model="id">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-nama" wire:model="nama" type="text" placeholder="Masukkan Nama Usaha">
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" wire:model="deskripsi" id="grid-deskripsi" type="textarea" placeholder="Masukkan Deskripsi Usaha">
          ...
          @if(count($errors) > 0)
            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th width="1%">Foto</th>
                    <th>Nama Usaha</th>
                    <th width="1%">Deskrispi Usaha</th>
                    <th width="1%">Semester</th>
                    <th width="1%">OPSI</th>
                </tr>
                </thead>
                <tbody>
                @foreach($beasiswa as $g)
                    <tr>
